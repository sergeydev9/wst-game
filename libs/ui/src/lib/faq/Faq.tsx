    ...
    return (
        <div className="row-span-1 col-span-6 lg:col-span-4 lg:col-start-2 text-center flex flex-col gap-4 w-full justify-self-center">
            ...
            <FaqItem question="Is Who Said True appropriate for all ages? ">
                ...
                Each Question Deck has a “Movie Rating” from PG to R. For a completely “clean” game experience, navigate over to <a href="http://www.whosaidtrueforschools.com" className="text-blue-base underline">“Who Said True for Schools”</a>
            </FaqItem>
