...
export const NumberTrueGuess = () => (
    <QuestionCard questionNumber={1} totalQuestions={10} category="Entertainment" >
        <NumberTrueGuessComponent totalPlayers={15} submitHandler={(v) => null} questionText="“I’ve binge watched an entire season of a show in a weekend.”"></NumberTrueGuessComponent>
    </QuestionCard>)