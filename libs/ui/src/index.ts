...
export { default as PaymentMethodSelect } from './lib/modal/payment-method-select/PaymentMethodSelect';
...
export { default as RemovePlayers } from './lib/modal/remove-players/RemovePlayers';
export { default as RemovePlayersRow } from './lib/modal/remove-players/RemovePlayersRow';
