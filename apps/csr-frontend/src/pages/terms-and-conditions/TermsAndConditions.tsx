...
const TermsAndConditions = () => {
    ...
    return (
        <InfoPage title="Terms &amp; Conditions">
            ...
            <ul className="pl-4 flex flex-col gap-4">
                <li>By email: <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="681b1d1818071a1c281f00071b09010c1c1a1d0d460b0705">[email&#160;protected]</a></li>
