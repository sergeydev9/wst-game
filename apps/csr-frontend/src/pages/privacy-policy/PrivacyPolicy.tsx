    ...
    <InfoPage title="Privacy Policy">
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to CenterPoint Systems, Inc., 7952 Lismore Cir,
        ...
        <li>
          <strong>Website</strong> refers to Who Said True, accessible from{' '}
          <a
            href="https://www.WhoSaidTrue.com"
            rel="external nofollow noopener noreferrer"
            target="_blank"
          >
            https://www.WhoSaidTrue.com
          </a>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          vendors for payment processing, or other third-party vendors that We
      ...
      <ul>
        ...
        <li>
          <strong>The right to request.</strong> Under CCPA, You have the right
        ...
        <li>
          ...
          to request the deletion of Your Personal Data, subject to certain
      ...
      <ul>
        <li>
          ...
          <a
            ...
            data-cfemail="10636560607f62645047787f43717974446265753e737f7d"
          >
            [email&#160;protected]
          </a>
        </li>
      ...
      <ul>
        <li>
          ...
          <a
            href="/cdn-cgi/l/email-protection"
            className="__cf_email__"
            data-cfemail="53202623233c212713043b3c00323a37072126367d303c3e"
          >
            [email&#160;protected]
          </a>
        </li>
