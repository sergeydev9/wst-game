import { InfoPage } from '@whosaidtrue/ui';

const PrivacyPolicy: React.FC = () => {

    // DEV_NOTE: props in InfoPage component get applied to the element that contains the children
    return (
        <InfoPage className="flex flex-col gap-4" title="Privacy Policy">
            ...
            <ul className="pl-4 flex flex-col gap-4">
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CenterPoint Systems, Inc., 7952 Lismore Cir, Eden Prairie, MN 55347.</p>
                ...
                <li>
                    <p><strong>Website</strong> refers to Who Said True, accessible from <a href="https://www.WhoSaidTrue.com" rel="external nofollow noopener" target="_blank">https://www.WhoSaidTrue.com</a></p>
                </li>
                <li>
            ...
            <ul className="pl-4 flex flex-col gap-4">
                <li>By email: <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="10636560607f62645047787f43717974446265753e737f7d">[email&#160;protected]</a></li>
            </ul>
            ...
            <ul className="pl-4 flex flex-col gap-4">
                <li>By email: <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="53202623233c212713043b3c00323a37072126367d303c3e">[email&#160;protected]</a></li>
